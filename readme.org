...
After cloning, run
: contracts-and-testing/bex/setup/install-racket-and-setup.sh
with two arguments:
1. The "project root".
   Typically, this should be the parent directory into which you cloned this repo.
2. A setup config, typically one of =contracts-and-testing/bex/setup/*-setup-config.rkt=.
...
2. Modify [[file:~/github_sync/grad/projects/blame-gradual-typing/src/contracts-and-testing/bex/orchestration/experiment-info.rkt][bex/orchestration/experiment-info.rkt]] as necessary.
...
1. a host on which to run the experiment (referring to one of the hosts defined in [[file:~/github_sync/grad/projects/blame-gradual-typing/src/contracts-and-testing/bex/orchestration/experiment-manager.rkt][bex/orchestration/experiment-manager.rkt]]), and
...
The options are defined in [[file:~/github_sync/grad/projects/blame-gradual-typing/src/contracts-and-testing/bex/orchestration/experiment-manager.rkt][bex/orchestration/experiment-manager.rkt]] above =main= (the =hosts= and related definitions).
