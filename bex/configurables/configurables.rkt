...
(define-configurable mutant-sampling
                     ...
                     (define-implementation none #:module "mutant-sampling/no-sampling.rkt")
...
(define-configurable mutant-filtering
                     ...
                     (define-implementation none #:module "mutant-filtering/none.rkt")
                     (define-implementation dont-care-about-blame-trails
                                            #:module
                                            "mutant-filtering/dont-care-about-blame-trails.rkt")
...
(define-configurable
 ...
 (define-implementation none #:module "module-instrumentation/none.rkt")
 (define-implementation insert-test #:module "module-instrumentation/insert-test.rkt")
 ...
 (define-implementation erasure-types #:module "module-instrumentation/type-with-erasure.rkt")
 (define-implementation add-ctc-level #:module "module-instrumentation/add-ctc-level.rkt"))
...
(define-configurable
 ...
 (define-implementation
  instrument-modules-and-insert-interface-adapter-module
  #:module "program-instrumentation/instrument-modules-and-insert-interface-adapter-module.rkt")
 (define-implementation
  instrument-modules-and-insert-empty-interface-middle-module
...
(define-configurable benchmark-runner
                     ...
                     (define-implementation run-it #:module "benchmark-runner/run-it.rkt")
                     (define-implementation none #:module "benchmark-runner/nothing.rkt")
                     (define-implementation teco-run #:module "benchmark-runner/teco-run.rkt")
...
(define-configurable blame-following
                     ...
                     (define-implementation null #:module "blame-following/null.rkt")
...
(define-configurable
 ...
 (define-implementation TR-interface-to-module-that-declared-the-type
                        #:module
                        "blame-translation/TR-interface-to-module-that-declared-the-type.rkt")
...
(define-configurable bt-root-sampling
                     ...
                     (define-implementation subset-random-with-replacement
                                            #:module
                                            "bt-root-sampling/subset-random-w-replacement.rkt"
...
(define-configurable
 ...
 #:provides [serialize-config
             ...
             configure-benchmark]
 (define-implementation module-types #:module "configurations/module-types.rkt")
 (define-implementation module-export-ctcs #:module "configurations/module-export-ctcs.rkt")
 (define-implementation top-level-id-ctcs #:module "configurations/top-level-id-ctcs.rkt")
 (define-implementation teco-configs #:module "configurations/teco-configs.rkt"))
